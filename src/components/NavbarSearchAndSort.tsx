...
const NavbarSearchAndSort: React.FC<NavbarSearchAndSortProps> = ({
  ...
  return (
    <div className="flex gap-2 w-full items-center justify-between p-2">
      <div className="flex items-center gap-1 bg-gray-700 text-white rounded-md text-sm justify-start w-full">
        <Search className="ml-2 text-gray-400 w-4 h-4" />
        <input
          type="text"
          placeholder="Search..."
          className=" pr-2 py-1 bg-gray-700 text-white rounded-md text-sm focus:outline-none focus:ring-1 focus:ring-blue-500"
          value={searchTerm}
      ...
      <DropdownMenu>
        <DropdownMenuTrigger className="flex items-center p-1 rounded-md bg-gray-700 text-white hover:bg-blue-500">
      ...
      <button
        ...
        className="p-1 rounded-md bg-gray-700 text-white hover:bg-blue-500"
      >
